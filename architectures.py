...
from Steerable_CNPs import cov_activ_func 
...
class SteerDecoder(nn.Module):
    ...
    def give_feat_types(self):
        ...
        pre_cov_rep=cov_activ_func.get_pre_cov_rep(self.G_act,self.dim_cov_est)
    ...
    def create_model_from_dict(dictionary):
        ...
        Output: Decoder - instance of SteerDecoder (see above) 
        '''
        Decoder=SteerDecoder( hidden_reps_ids=dictionary['hidden_reps_ids'],
                                kernel_sizes=dictionary['kernel_sizes'],
                                dim_cov_est=dictionary['dim_cov_est'],
    ...
    def load_model_from_dict(filename):
        ...
        Output: instance of SteerDecoder with parameters as specified at "filename"
        '''
        dictionary=torch.load(f=filename)
        return(SteerDecoder.create_model_from_dict(dictionary))
